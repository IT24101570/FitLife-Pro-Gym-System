...
@AndroidEntryPoint
public class DoctorActivity extends AppCompatActivity implements MainService.IncomingCallListener {
    ...
    private void checkProfileStatus() {
        ...
        databaseReference.child("professionals").child(doctorId)
    ...
    private void enableButtons(boolean enabled) {
        cardConsultations.setEnabled(enabled);
