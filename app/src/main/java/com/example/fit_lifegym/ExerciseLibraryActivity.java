...
public class ExerciseLibraryActivity extends AppCompatActivity implements ExerciseLibraryAdapter.OnExerciseClickListener {
    ...
    public void onExerciseClick(ExerciseLibrary exercise) {
        if (exercise.isPremium() && !sessionManager.isPremiumUser()) {
            showPremiumDialog();
        } else {
    ...
    private void showPremiumDialog() {
        new AlertDialog.Builder(this)
            ...
            .setMessage("This exercise is part of our Elite library. Upgrade your plan to unlock all professional training content.")
            .setPositiveButton("View Plans", (dialog, which) -> {
                try {
                    startActivity(new Intent(this, Class.forName("com.example.fit_lifegym.SubscriptionActivity")));
                } catch (ClassNotFoundException e) {
                    Toast.makeText(this, "Subscription plans coming soon!", Toast.LENGTH_SHORT).show();
                }
            })
