...
import com.example.fit_lifegym.PaymentActivity;
...
public class BookingAdapter extends RecyclerView.Adapter<BookingAdapter.BookingViewHolder> {
    ...
    public void onBindViewHolder(@NonNull BookingViewHolder holder, int position) {
        ...
        if (booking.isConfirmed()) {
            ...
            holder.btnPayNow.setOnClickListener(v -> {
                ...
                intent.putExtra("planType", "Booking Session: " + booking.getProfessionalName());
                intent.putExtra("price", booking.getPrice());
                intent.putExtra("billingCycle", "One-time Session");
    ...
    public static class BookingViewHolder extends RecyclerView.ViewHolder {
        ...
        Button btnJoinSession, btnVideoCall, btnAudioCall, btnPayNow;
