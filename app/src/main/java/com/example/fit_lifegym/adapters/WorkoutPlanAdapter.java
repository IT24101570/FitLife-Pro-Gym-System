...
public class WorkoutPlanAdapter extends RecyclerView.Adapter<WorkoutPlanAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (plan.getCreatorName() != null) {
            holder.tvTrainerName.setText(holder.itemView.getContext().getString(R.string.label_curated_by, plan.getCreatorName()));
            holder.tvTrainerName.setVisibility(View.VISIBLE);
        } else {
            holder.tvTrainerName.setText(holder.itemView.getContext().getString(R.string.label_curated_by, "System"));
            holder.tvTrainerName.setVisibility(View.VISIBLE);
        }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        TextView tvPlanName, tvGoal, tvDifficulty, tvDescription, tvDuration, tvWorkouts, tvTrainerName;
        Button btnActivate;
