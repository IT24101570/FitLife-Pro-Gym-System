...
public class TrainerActivity extends AppCompatActivity implements MainService.IncomingCallListener {
    ...
    private MaterialCardView cardManageProfile, cardSessions, cardAvailability, cardWorkoutPlans, btnPersonalizedPlan, cardManageVideos;
    ...
    private void setupListeners() {
        ...
        // Link to the Workout Plans management for trainer
        cardWorkoutPlans.setOnClickListener(v -> {
            if (v.isEnabled()) {
                startActivity(new Intent(this, TrainerWorkoutPlanActivity.class));
            } else {
                showPendingToast();
            }
        });
        btnPersonalizedPlan.setOnClickListener(v -> {
            if (v.isEnabled()) {
                startActivity(new Intent(this, TrainerGuidanceActivity.class));
            } else {
                showPendingToast();
            }
        });
        btnRatings.setOnClickListener(v -> {
            Intent intent = new Intent(this, ProfessionalReviewsActivity.class);
            intent.putExtra("professionalId", sessionManager.getUserId());
            startActivity(intent);
        });
        cardManageVideos.setOnClickListener(v -> startActivity(new Intent(this, ManageVideosActivity.class)));
    ...
    private void enableButtons(boolean enabled) {
        ...
        cardManageVideos.setEnabled(enabled);
        ...
        cardManageVideos.setAlpha(alpha);
    }
