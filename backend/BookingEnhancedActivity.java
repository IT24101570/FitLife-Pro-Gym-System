...
public class BookingEnhancedActivity extends AppCompatActivity {
    ...
    private static final String TAG = "BookingEnhancedActivity";
    ...
    private void initializeViews() {
        ...
        professionalAdapter = new ProfessionalAdapter(filteredProfessionals, (professional, position) -> {
    ...
    private void loadProfessionalsFromFirebase() {
        professionalsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Log.d(TAG, "Loading professionals. Target type: " + bookingType);
                for (DataSnapshot ds : snapshot.getChildren()) {
                    Professional p = ds.getValue(Professional.class);
                    if (p != null) {
                        p.setId(ds.getKey());
                        String pType = p.getType() != null ? p.getType() : "";
                        String pStatus = p.getApprovalStatus() != null ? p.getApprovalStatus() : "";
                        
                        Log.d(TAG, "Checking professional: " + p.getName() + ", Type: " + pType + ", Status: " + pStatus);
                        
                        // Use case-insensitive comparison for both type and status
                        if (bookingType.equalsIgnoreCase(pType) && "APPROVED".equalsIgnoreCase(pStatus)) {
                ...
                if (allProfessionals.isEmpty()) {
                    Log.d(TAG, "No professionals found matching the criteria.");
                    Toast.makeText(BookingEnhancedActivity.this, "No approved " + bookingType + "s available yet.", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(BookingEnhancedActivity.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
